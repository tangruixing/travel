...
(function ($) {
    ...
    function _bc(_bd, _be) {
        ...
        var _c0 = _bf.options;
        var dc = _bf.dc;
        //clear checkTrsBody1å’ŒcheckTrsBody2
    ...
    var _1de = {
        render : function (_1df, _1e0, _1e1) {
            ...
            //alert("æ‰§è¡Œäº† " + (end-start) + " æ¯«ç§’");
            //$(_1e0).html(_1e4.join(""));
            $(_1e0)[0].innerHTML = _1e4.join("");
            var third = new Date().getTime();
            //alert("æ‰§è¡Œäº† " + (third-end) + " æ¯«ç§’");
        },
                        ...
                        if (type == "body") {
                            ...
                            if (type == "footer") {
                                ...
                                if (type == "selected") {
                                    ...
                                    //å¦‚æžœæ˜¯æœªå®šä¹‰ï¼Œåˆ™è¿”å›žä¸€ä¸ªjQueruç©ºå¯¹è±¡ï¼Œç¡®ä¿addå‡½æ•°ä¸ä¼šæŠ¥é”™
                                    $trs = $trs || $(undefined);
                                    return $trs;
                                } else {
                                    if (type == "highlight") {
