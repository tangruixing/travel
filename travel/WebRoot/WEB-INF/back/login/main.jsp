...
<h1 style="font-size:24px;">你好</h1>
    ...
    <form id="userEditPwdFm" method="post">
        <table>
            ...
            <tr>
                <td>新密码:</td>
                <td><input id="newpassword" class="easyui-textbox easyui-validatebox"   type="password"  data-options="iconCls:'icon-lock',required:true,missingMessage:'请输入新密码',validType:'safepass'" ></td>
            </tr>
			...
			<tr>
                <td>确认密码:</td>
                <td>
				<input id="confirm_password"  class="easyui-textbox easyui-validatebox"   type="password"  data-options="iconCls:'icon-lock',required:true,missingMessage:'请确认密码',validType:'eqPassword[#newpassword]'" > <!--   -->
				</td>
            </tr>
        </table>
